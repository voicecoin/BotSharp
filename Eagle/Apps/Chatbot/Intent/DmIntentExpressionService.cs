...
namespace Apps.Chatbot.Intent
{
    ...
    {
        public static void Update(this IntentExpressionEntity intentExpression)
        {
            //Database dc = intentExpression.Dc;
            // Remove Items first
        ...
        public static void Delete(this IntentExpressionEntity intentExpression)
        {
            //Database dc = intentExpression.Dc;
            // Remove Items first
        ...
        public static void Add(this IntentExpressionEntity intentExpression)
        {
