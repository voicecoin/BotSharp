...
namespace Core
{
    ...
    public class DbFactoryController : CoreController
    {
        ...
        {
            return Assembly.Load(new AssemblyName("Core"))
                .GetTypes().Union(Assembly.Load(new AssemblyName("Apps")).GetTypes())
                .ToList();
        }
        ...
        public Object Find(string table, string id)
        {
            ...
            Type tableType = GetTypes().FirstOrDefault(t => t.Name == table);
